import { Product } from "@/contexts/ShoppingCart";
...
export const ProductCard: FC<{
  ...
  return (
    <div className="h-[420px] w-[250px] flex items-end justify-end rounded-3xl relative overflow-hidden">
      <svg
        id="wave"
      ...
      >
        ...
        />
        <div className="flex flex-col justify-end items-center w-full h-full p-3 gap-3 pb-5">
